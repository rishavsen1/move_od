...
- go_time/time_0(string): time the person leaves the home - in 24 hour format (as a string)
- return_time/time_1(string): time the person leaves the workplace - in 24 hour format (as a string)
