...
class MS_Buildings:
    ...
    def __init__(self, county, county_cbg, builds, data_path, logger) -> None:
        self.COUNTY = county
    ...
    def buildings(self):
        ...
        county_cbg = self.state_cbg[
            self.state_cbg["COUNTYFP"] == self.COUNTY
        ...
        county_builds["location"] = county_builds.geo_centers.apply(
            lambda p: [p.y, p.x]
        )
